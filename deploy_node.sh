...
ssr_url="https://github.com/wcbai/shadowsocksr.git"
...
v2_installer="https://raw.githubusercontent.com/wcbai/Shell/master/v2ray-ssrpanel-plugin-install.sh"
v2_config="https://raw.githubusercontent.com/wcbai/v2ray/master/config.json"
caddy_www="https://raw.githubusercontent.com/wcbai/Shell/master/resource/www.zip"
caddy_config="https://raw.githubusercontent.com/wcbai/Shell/master/resource/Caddyfile"
...
install_caddy() {
	...
	local caddy_tmp_file="/tmp/install_caddy/caddy.tar.gz"
		wget --no-check-certificate -O /usr/local/bin/caddy https://github.com/4kercc/all-script/raw/master/caddy
	...
	if [[ $systemd ]]; then
		wget --no-check-certificate -O /lib/systemd/system/caddy.service https://github.com/4kercc/all-script/raw/master/caddy.service
